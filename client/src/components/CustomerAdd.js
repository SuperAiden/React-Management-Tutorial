...
import {post} from 'axios'; //서버와의 통신 목적의 라이브러리
...
class CustomerAdd extends React.Component{
    ...
    addCustomer = () => {
        ...
        const config = {
            header: {
                'content-type': 'multipart/form-data'//전달하는 데이터에 파일이 포함되어 있을 때
            }
        }
                ...
                <Dialog open={this.state.open} onClose={this.handleClose}>
                    ...
                    <DialogContent>
                        ...
                        <label htmlFor="raised-button-file">
                            <Button variant="contained" color="primary" component="sapn" name="file">
                                {this.state.fileName === "" ? "프로필 이미지 선택 " : this.state.fileName}
                            </Button>
                        </label>
                        <br/>
                        <TextField label="이름" name="userName" vlaue={this.state.userName} onChange={this.handleValueChange} /><br />
